...
export function generateQuotePDF({
  ...
  // Notes may intentionally be blank in Settings, in which case the PDF does
  // not render an empty terms section.
  if (company.quoteNotes) {
    doc.setFont("helvetica", "bold");
    doc.text("Notes:", 14, finalY + 20);
    doc.setFont("helvetica", "normal");
    doc.text(company.quoteNotes, 14, finalY + 28, { maxWidth: 115 });
  }
